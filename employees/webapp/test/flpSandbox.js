		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestión de datos de empleados",
									"targetURL": "#hcmemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hcmemployees-display": {
								"semanticObject": "hcmemployees",
								"action": "display",
								"description": "Manejo de datos de empleados",
								"title": "Gestión de datos de empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hcm.employees",
									"url": sap.ui.require.toUrl("hcm/employees")
								}
							}
						}
					}
